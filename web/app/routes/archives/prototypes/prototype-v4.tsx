        ...
        <div className="space-y-0.5">
          {trips.map((trip) => (
            <Button
              ...
              asChild
            >
              <Link to="/prototype-v4">{trip.name}</Link>
            </Button>
          ))}
        </div>
      </div>
...
// =============================================================================
// CARD GRID COMPONENT (List view for Plans and Sources)
// =============================================================================
...
// =============================================================================
// CONTENT HEADER COMPONENT (Tabs for list, Back+Title for editor)
// =============================================================================
// DOCUMENT PANEL COMPONENT (Section with list/editor states)
// =============================================================================
...
function DocumentPanel() {
  ...
  // Active view state (Plans vs Sources)
  ...
  if (viewState === "list") {
    return (
      <div className="h-full flex flex-col">
        {/* Header: View picker combobox + New button */}
        <div className="px-4 py-2 border-b shrink-0 flex items-center justify-between">
          <Popover open={openViewPicker} onOpenChange={setOpenViewPicker}>
            <PopoverTrigger asChild className="">
              <Button
                variant="ghost"
                role="combobox"
        ...
        <ScrollArea className="flex-1 min-h-0">
          <div className="p-4">
            ...
            <CardGrid
              ...
              emptyMessage={
                activeView === "plans" ? "No plans yet" : "No sources yet"
              }
            />
          </div>
        </ScrollArea>
...
function ContentArea() {
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      {/* Trip Header - spans full width (Document + Chat) */}
      ...
      >
        {/* Document panel - has its own header */}
        <ResizablePanel
...
export default function PrototypeV4Route() {
