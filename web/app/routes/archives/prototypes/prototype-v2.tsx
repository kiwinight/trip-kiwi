...
export default function PrototypeV2Route() {
  ...
  if (navCollapsed) {
    return (
      <div className="h-screen max-h-screen w-full overflow-hidden flex">
        ...
        <div className="w-[52px] min-w-[52px] max-w-[52px] shrink-0">
        ...
        >
          <ResizablePanel defaultSize={100 - CHAT_DEFAULT_SIZE} minSize={30}>
            <MainContent />
          </ResizablePanel>
  ...
  return (
    ...
    >
      ...
      {/* Middle: main content */}
      <ResizablePanel
        defaultSize={100 - navDefaultSize - CHAT_DEFAULT_SIZE}
        minSize={30}
        className="overflow-hidden"
      >
        <MainContent />
